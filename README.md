...
Metrics: Achieved an [Insert your accuracy, e.g., 91%] accuracy rate with a focus on minimizing False Negatives (missing a disease is more costly than a false alarm).
